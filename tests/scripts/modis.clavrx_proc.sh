...
python $GEOIPS_PACKAGES_DIR/geoips_clavrx/geoips_clavrx/ancillary/update_dynamic.py 20240607

# run test
python $GEOIPS_PACKAGES_DIR/geoips_clavrx/geoips_clavrx/test/test_clavrx.py -i MODIS
...
#     --compare_path "$GEOIPS_PACKAGES_DIR/geoips_clavrx/tests/modis.<product>.imagery_clean" \
run_procflow \
    $GEOIPS_OUTDIRS/clavrx_products/testing/modis/*.hdf \
